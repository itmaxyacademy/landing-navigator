...
export const translations = {
  id: {
    ...
    freeTierSubtitle: 'Promo Soft Launching - Akses Uji Coba 3 Modul Dasar & Pengenalan AI Navigator',
    freeTierPrice: 'Gratis (Rp 0)',
    freeTierFeatures: [
      'Akses 3 Modul Pengenalan AI & Prompting',
    ...
    selectFreeTier: 'Coba Gratis (3 Modul)',
  ...
  en: {
    ...
    freeTierTitle: 'Free Trial / Starter',
    freeTierSubtitle: 'Promo Soft Launching - 3-Module Trial Access to Basic AI Modules & Navigator Intro',
    freeTierPrice: 'Free (Rp 0)',
    freeTierFeatures: [
      '3 Modules Access to Introductory AI & Prompting Modules',
    ...
    selectFreeTier: 'Try Free (3 Modules)',
    tier1Title: 'Tier 1: Self-Paced Basic',
