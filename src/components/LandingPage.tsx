      ...
      <footer className="relative bg-[#050914] text-slate-300 pt-16 pb-12 px-6 lg:px-16 border-t border-slate-800/80 font-sans">
        ...
        <div className="fixed bottom-6 right-6 z-40 flex flex-col items-end gap-3">
          ...
          <motion.button
            ...
            className="w-12 h-12 rounded-2xl bg-[#0b0f19] border border-slate-800 text-white flex items-center justify-center shadow-xl shadow-slate-950/40 hover:border-amber-400/50 transition-all cursor-pointer group"
            title="Klaim Voucher / Giveaway"
          >
            <Gift className="w-5 h-5 text-white group-hover:text-amber-400 group-hover:scale-110 transition-all" />
          </motion.button>
          ...
          <motion.a
            whileHover={{ scale: 1.08 }}
            whileTap={{ scale: 0.92 }}
            href="https://wa.me/628113955599?text=Halo%20Admin%20Maxy%20Academy,%20saya%20ingin%20tanya%20mengenai%20Program%20Certified%20AI%20Navigator"
            target="_blank"
            rel="noopener noreferrer"
            className="w-12 h-12 rounded-2xl bg-[#25D366] text-white flex items-center justify-center shadow-xl shadow-[#25D366]/30 hover:bg-[#20bd5a] transition-all cursor-pointer"
            title="Hubungi WhatsApp Support (0811-3955-599)"
          >
