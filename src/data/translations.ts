...
export const translations = {
  id: {
    ...
    badgesFooterDesc: 'Setiap peserta yang lulus program 28 hari ini langsung memperoleh Sertifikat Resmi & Digital Badge CAAI™ Level 1 (Amateur).',
  ...
  en: {
    ...
    badgesFooterDesc: 'Graduates of this 28-day program earn the Official Verified CAAI™ Level 1 (Amateur) Certificate and Digital LinkedIn Badge.',
    holonIqTitle: 'Southeast Asia EdTech Top 50',
    holonIqSubtitle: 'Recognized by HolonIQ & QS World University Rankings',
